...
import com.superm.easy.cloud.auth.authorization.config.custom.CustomTokenEnhancer;
...
public class AuthenticationServerConfigure extends AuthorizationServerConfigurerAdapter {
    @Autowired
